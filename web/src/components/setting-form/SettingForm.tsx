...
const SettingForm = () => {
    ...
    const handleInput = () => {
        ...
        if (description !== '') userData = {...userData, description};
        ...
        <div className="center">
            <div className="profile-form">
                <div className="profile-header-container">
                    <img className="profile-header-img" src={user.profile ? user.profile : "profile.png"} alt="user profile" />
                    <div className="profile-header-username>">
                        <h1 className="profile-header-username-text>">{user.username}</h1>
                        <button id="modal-btn" className="profile-header-username-btn" onClick={showModal}>프로필 사진 바꾸기</button>
                    </div>
                </div>
                ...
                <div className="profile-input-container">
                    <div className="profile-input-label"></div>
                    <div className="profile-input-data">
                        <button className="profile-input-button" type="button" onClick={changePassword}>비밀번호 변경</button>
                    </div>
                </div>
                <div className="profile-input-container">
                    {errorMsg !== "" && <div className="profile-form">{errorMsg}</div>}
                </div>
